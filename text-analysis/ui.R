  ...
  mainPanel( 
    tabsetPanel(type = "tabs",
                ...
                tabPanel("DTM",
                         ...
                         p("adjust the minimum frequency of words to be included in DTM from the panel on the left"),
                         ...
                         h4("Word Cloud"),
                         p("adjust the maximum number of words in the word cloud in the panel on the left"),
                ...
                tabPanel("TF-IDF", 
                         ...
                         p("adjust the minimum frequency of words to be included in TF-IDF from the panel on the left"),
