...
shinyUI(fluidPage(
  ...
  sidebarPanel(
   ...
   # h4(p("Data Input")),
    ...
    sliderInput("max",  "Maximum number of words in wordcloud:", min = 10,  max = 100,  value = 50), 
  ...
  mainPanel( 
    tabsetPanel(type = "tabs",
                ...
                tabPanel("DTM",
                         ...
                         p("click on 'Apply Changes' in the left panel"),
                         ...
                         shinycssloaders::withSpinner(plotOutput("wordcloud",height = 700, width = 700)),br(),
                ...
                tabPanel("TF-IDF", 
                         ...
                         h4("Word Cloud"),
                         p("adjust minimum frequency and maximum number of words in the wordcloud in the panel on the left"),
                         shinycssloaders::withSpinner(plotOutput("idf_wordcloud",height = 700, width = 700)),br(),
                         p("adjust minimum frequency and maximum number of words in the wordcloud in the panel on the left"),
                         #textInput("in",label = "text"),
                ...
                tabPanel("Concordance",
                         ...
                         textInput("concord.word",('word (sub-string) in lower case'),value = 'was'),
                ...
                tabPanel("Term Co-occurrence",
                         numericInput("nodes", "Number of Central Nodes", 4),
                         numericInput("connection", "Max Connection with Central Node", 5),
                         h4("DTM Co-occurrence"),
                         shinycssloaders::withSpinner(visNetworkOutput("cog.dtm",height = 700, width = 700)),
                ...
                tabPanel("Bigram",
                         ...
                         shinycssloaders::withSpinner(plotOutput("bi_word_cloud",height=700,width=700)),
                         p("adjust minimum frequency and maximum number of words in the wordcloud in the panel on the left"),
                         br() )
