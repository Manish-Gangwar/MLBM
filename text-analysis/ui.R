  ...
  mainPanel( 
    tabsetPanel(type = "tabs",
                ...
                tabPanel("DTM",
                         ...
                         shinycssloaders::withSpinner(plotOutput("wordcloud",height = 500, width = 500)),br(),
                ...
                tabPanel("TF-IDF", 
                         ...
                         h4("Word Cloud"),
                         p("adjust minimum frequency and maximum number of words in the wordcloud in the panel on the left"),
                         shinycssloaders::withSpinner(plotOutput("idf_wordcloud",height = 500, width = 500)),br(),
                         p("adjust minimum frequency and maximum number of words in the wordcloud in the panel on the left"),
                         #textInput("in",label = "text"),
                ...
                tabPanel("Term Co-occurrence",
                         ...
                         shinycssloaders::withSpinner(visNetworkOutput("cog.dtm",height = 500, width = 500)),
                         h4("TF-IDF Co-occurrence"),
                         visNetworkOutput("cog.idf",height = 500, width = 500),
                        br()),
                tabPanel("Bigram",
