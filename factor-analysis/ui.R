...
tags$a(href="https://en.wikipedia.org/wiki/Factor_analysis", "-Wikipedia",target="_blank"),
br(),br(),
...
#img(src = "example1.png") #, height = 280, width = 400
                ...
                tabPanel("Data",#h4("Selected Variables"), verbatimTextOutput("head"),#verbatimTextOutput("tail"),
...
#                tabPanel("Scores",tableOutput("scores")),   # origi code
                ...
                tabPanel("Scores", 	# tab name
                        ...
                        br(),
	                      downloadButton('downloadDataX', 'download factor scores file'), 
	                      br(),br(),
